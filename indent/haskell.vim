...
" Local defaults
setlocal expandtab
setlocal indentexpr=GetHaskelmIndent()
setlocal indentkeys+=0=else,0=if,0=of,0=import,0=then,0=data,0\|,0},0\],0),=-},0=in
setlocal nolisp
...
function! GetHaskelmIndent()
	...
	if l:lline =~# '\(|\|=\|->\|<-\|(\|\[\|{\|\$\|\<\(of\|else\|if\|then\|where\|do\)\)\s*$'
